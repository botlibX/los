...
from los.loggers import LEVELS
from los.objects import Object, edit, fmt, keys
from los.persist import getpath, last, write
from los.threads import launch
...
class Config:
    ...
    def __init__(self, cfg):
        self.channel = cfg.channel or f"#{cfg.name}"
        self.commands = cfg.commands or True
        self.name = cfg.name or "los"
        self.nick = cfg.nick or self.name
        self.password = ""
        self.port = cfg.port or 6667
        self.realname = cfg.realname or self.name
        self.server = cfg.server or "localhost"
        self.servermodes = ""
        self.sleep = 60
        self.username = cfg.username or self.name
